...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('doctor', '0026_alter_doctor_join_date_alter_serial_issue_date_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='doctor',
            name='join_date',
            field=models.DateTimeField(default=datetime.datetime(2023, 3, 19, 20, 47, 56, 216000)),
        ),
        migrations.AlterField(
            model_name='serial',
            name='issue_date',
            field=models.DateTimeField(default=datetime.datetime(2023, 3, 19, 20, 47, 56, 217994)),
        ),
        migrations.AlterField(
            model_name='serial',
            name='visit_date',
        ...
        migrations.AlterField(
            model_name='staff',
            name='join_date',
            field=models.DateTimeField(default=datetime.datetime(2023, 3, 19, 20, 47, 56, 217001)),
        ),
